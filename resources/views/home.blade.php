            ...
            <form class="col-lg-12 col-md-12 col-sm-12 col-xs-12" name="form" id="ajax_form" action="" method="post"
                    ...
                    <div class="row forms">
                        ...
                        <div class="try d-flex justify-content-center">
                            <div class="true">
                                    <input type="button" class="form-text btn btn-success add" data-action="add" value="Добавить перелет"/>
                            </div>
                            <div class="true">
                                    <input type="button" class="form-text btn btn-success add" data-action="addhotel" value="Добавить отель"/>
                            </div>
                            <div class="true">
                                <div class="sfr">
