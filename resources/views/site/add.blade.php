            ...
            <div class="row">
                <div class=" col-lg-4 col-md-4 col-sm-12 col-xs-12 navbar-header">
                    <div>
                        ...
                        <img class="trip optimizer logo" src="img/trip optimizer logo.png" style="width:15%;">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form action="{{url('/home/add')}}" method="post" enctype="multioart/form-data">
                        <div class="row my-row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label class="birthday">Дата рождения:</label><br>
                        ...
                        <div class="row my-row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12r">
                                <label class="first-name">Имя:</label><br>
                        ...
                        <div class="row my-row">
                             <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 ...
                                 <input type="text" class="input form-control" name="patronymic" id="patronymic" value="{{ old('patronymic') }}">
                             </div>
                        </div>
                        ...
                        <div class="row my-row">
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label>Пол:</label><br>
                                <p>
                                    <input type="checkbox" name="sex" id="sex" value="M"><label class="check">Мужской</label><Br>
                                    <input type="checkbox" name="sex" id="sex" value="F"><label class="check">Женский</label><Br>
                                </p>
                            </div>
                        </div>
                        <div class="row my-row">
                        ...
                        <div class="row my-row">
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <p>
                                    <input type="checkbox" name="visa" id="visa" value="NO"><label class="check">Нет</label><Br>
                                    <input type="checkbox" name="visa" id="visa" value="YES"><label class="check">Да</label><Br>
                                </p>
                            </div>
                        </div>
                        <div class="row my-row">
                            <label class="my-btn"><button>Создать аккаунт</button>
                            </label>
